...
import { getInstrument, levels } from "@/lib/site-data";
...
export const Route = createFileRoute("/instruments/$slug")({
  ...
  notFoundComponent: () => <div className="mx-auto max-w-xl p-16 text-center"><h1 className="font-display text-3xl font-bold">Instrument not found</h1><p className="mt-2 text-muted-foreground">Try a different instrument from the list.</p><Button asChild className="mt-6 rounded-full"><Link to="/instruments">All instruments</Link></Button></div>,
});
      ...
      <section className="border-b border-border bg-noise">
        <div className="mx-auto grid max-w-7xl gap-10 px-4 py-16 sm:px-6 md:grid-cols-2 lg:px-8">
          <div className="flex flex-col justify-center">
            ...
            <p className="mt-4 max-w-xl text-muted-foreground">{inst.description}</p>
